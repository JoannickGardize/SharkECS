...
class TransmutationConfiguratorTest {
    ...
    void configureTest() {
        ...
        ComponentMapper<Object> m1 = new ArrayComponentMapper<>(0, Object::new);
        ComponentMapper<Object> m2 = new ArrayComponentMapper<>(0, Object::new);
        ComponentMapper<Object> m3 = new ArrayComponentMapper<>(0, Object::new);
        ComponentMapper<Object> m4 = new ArrayComponentMapper<>(0, Object::new);
