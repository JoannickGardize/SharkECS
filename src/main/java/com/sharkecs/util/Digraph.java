 ...
 * <p>
 * Each node is identified by a value instance (by identity, not equality). Any
 * possible value instance is considered by the graph as a single node with zero
 * to many connections.
 * <p>
...
public class Digraph<T> {
	...
	private void topologicalSortVisit(List<T> result, Map<Node<T>, Boolean> toTreat, Node<T> node) throws GraphCycleException {
